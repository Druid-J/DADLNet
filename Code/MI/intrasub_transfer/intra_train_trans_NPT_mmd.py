...
def pearson(y_true, y_pred):
    ...
    mmd_loss = MMD(y_true, y_pred)
    loss = 0.5*pearson_loss+0.5*mmd_loss
    return loss
...
if __name__ == '__main__':
    ...
    for sub in sub_all:
        ...
        for tra_index, te_index in kf.split(X):
            ...
            if not os.path.exists(transfer_best_path):
                ...
                tra_model.save(os.path.join(transfer_best_path, 'transfer_Dense_3_400Hz_mmd.h5'))
            else:
                tra_model.save(os.path.join(transfer_best_path, 'transfer_Dense_3_400Hz_mmd.h5'))
        ...
        writerxlsx_1(
            path=os.path.join(best_dir, 'val_Dense_400Hz_3_mmd.xlsx'),
    ...
    writerxlsx_1(
        path=os.path.join('/home/xumeiyan/Public/Reslut/CMANet/Try/202201201_base3DCNN_OpenBMI_400Hz_2class_4_9channel_0.0625_Combined_Attention_1Layer/result',
                          'transfer_Dense_3_val_400Hz_mmd.xlsx'),
