...
from MI.DA.load_data_2 import get_all_data
...
if __name__ == '__main__':
    ...
    getLayer = None
    # imports
    save_path = '/home/xumeiyan/Public/Reslut/DADLNet/20230929_DADLNet_OpenBMI_400Hz_dependent_2class_4_9channel_2/feature64-64-64-128_ratio16_drop0.5_l20.001_batch32'
    # Import package
    ...
    for sub in sub_all:
        ...
        t_model = reset_model(1, t_model) # -3
        ...
        for tra_index, te_index in kf.split(X):
            ...
            new_model = reset_model(2, new_model) #-5
            m = m + 1
        ...
        # save result
        writerxlsx_1(
            path=os.path.join(best_dir, 'result_OpenBMI_intra.xlsx'),
