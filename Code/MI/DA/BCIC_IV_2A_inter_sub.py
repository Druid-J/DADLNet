...
from MI.DA.load_data_2 import get_all_data_Bci2a_inter
...
if __name__ == '__main__':
    ...
    getLayer = None
    # imports
    save_path = '/home/xumeiyan/Public/Reslut/DADLNet/20230927_DADLNet_BCIC2a_400Hz_independent_2class_4_9channel/' \
                'feature64-64-64-128_ratio16_drop0.5_l20.001_batch32'
    # Import package
    ...
    for sub in sub_all:
        ...
        x = tra_model.output
        x = tf.keras.layers.Dense(16, activation='elu', name='Dense_relevant_top')(x)  # 39
        x = dense_raw(x)
        x = sigmoid(x)
        ...
        writerxlsx_1(
            path=os.path.join(best_dir, 'result_BCI_inter.xlsx'),
